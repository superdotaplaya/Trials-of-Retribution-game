...
--[[
  ...
  -Ensure that you have the trialsofretribution_attachments.xml, trialsofretribution_attachments.js, and trialsofretribution_attachments.css files in your panorama content folder to use the GUI.
  -Ensure that trialsofretribution_attachments.xml is included in your custom_ui_manifest.xml with
    <CustomUIElement type="Hud" layoutfile="file://{resources}/layout/custom_game/trialsofretribution_attachments.xml" />
